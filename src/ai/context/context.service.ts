...
export class ContextService {
  async getProject(projectId: string): Promise<ProjectContext | undefined> {
    ...
    // TODO: wire to projects repository/service
    return undefined;
  }
  ...
  async getTasks(projectId: string): Promise<ReadonlyArray<TaskContext>> {
    ...
    // TODO: fetch tasks and normalize; apply deterministic sort and cap to TASKS_CAP
    return [];
  }
  ...
  async getTeam(projectId: string): Promise<ReadonlyArray<TeamMemberContext>> {
    ...
    // TODO: fetch minimal user profiles assigned/related to project
    return [];
  }
